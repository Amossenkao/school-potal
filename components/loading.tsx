		...
		switch (variant) {
			...
			case 'company':
				return (
					<div className="flex flex-col items-center gap-8">
						<style>{`
				@keyframes sm-signal-pulse {
					0%   { transform: translate(-50%, -50%) scale(0.35); opacity: 0.7; }
					100% { transform: translate(-50%, -50%) scale(1);    opacity: 0;   }
				}
				@keyframes sm-logo-breathe {
					0%, 100% { box-shadow: 0 0 0 0px rgba(70, 95, 255, 0); }
					50%       { box-shadow: 0 0 0 6px rgba(70, 95, 255, 0.08); }
				}
				...
				.sm-pulse-ring {
					...
					opacity: 0;
					animation: sm-signal-pulse 2.8s ease-out infinite;
					pointer-events: none;
				}
				.sm-pulse-ring:nth-child(1) { animation-delay: 0s;    }
				.sm-pulse-ring:nth-child(2) { animation-delay: 0.7s;  }
				.sm-pulse-ring:nth-child(3) { animation-delay: 1.4s;  }
				.sm-pulse-ring:nth-child(4) { animation-delay: 2.1s;  }
				...
				.sm-dot {
					...
					background: #465fff;
					opacity: 0.25;
					animation: sm-dot-blink 1.6s ease-in-out infinite;
				}
				.sm-dot:nth-child(1) { animation-delay: 0s;   }
			...
			`}</style>
						...
						<div className="relative" style={{ width: 180, height: 180 }}>
							<div className="sm-pulse-ring" />
							<div className="sm-pulse-ring" />
							<div className="sm-pulse-ring" />
							<div className="sm-pulse-ring" />

							<div className="sm-logo-tile">
								<img
						...
						{/* Wordmark + dots + optional message */}
						<div className="flex flex-col items-center gap-2">
							<p className="text-sm font-semibold tracking-wide text-foreground">
								School<span style={{ color: '#465fff' }}>Mesh</span>
							</p>
							<div className="sm-dot-row">
