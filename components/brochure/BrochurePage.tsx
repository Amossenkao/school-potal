...
const features = [
	...
	},
	{
		...
		description:
			'Students can view their reports, attendance, balances and schedules',
		color: '#06b6d4',
	},
	{
		icon: BarChart3,
	...
	},
	{
		...
		description:
			'Plan and manage school events, class timetables, and academic calendars in one place.',
		color: '#8b5cf6',
	},
];
...
const customPlan = {
	...
	description:
		'For schools and networks that prefer a fixed annual fee. We pre-agree a lump sum based on your projected enrollment — no per-student billing, predictable budgeting, and priority support.',
	features: [
...
function CompactDashboardMockup() {
	return (
		<div className="overflow-hidden rounded-lg border border-gray-200 bg-white text-[9px] leading-tight">
			<div className="flex border-b border-gray-200 bg-gray-50 px-2 py-1">
				...
				<div className="mx-auto flex items-center gap-1 rounded border border-gray-200 bg-white px-2 py-0.5 text-[7px] text-gray-400">
					<Lock className="h-[6px] w-[6px] text-[#12b76a]" />
					app.schoolmesh.io
				</div>
			</div>
			<div className="flex">
				<div className="hidden w-28 shrink-0 border-r border-gray-200 bg-[#111827] p-1.5 lg:block">
					...
					<div
						className="flex items-center gap-1 rounded bg-[#465fff]/30 px-1.5 py-0.5 text-[7px] text-white"
						style={{ borderLeft: '1.5px solid #465fff' }}
					>
						<LayoutDashboard className="h-2.5 w-2.5 opacity-80" />
						Dashboard
					</div>
					<div className="flex items-center justify-between rounded px-1.5 py-0.5 text-[7px] text-white/45">
					...
					<div className="flex items-center justify-between rounded px-1.5 py-0.5 text-[7px] text-white/45">
						<div className="flex items-center gap-1">
							<ClipboardList className="h-2.5 w-2.5 opacity-80" />
							Grading
						</div>
						<ChevronDown className="h-2 w-2 opacity-40" />
					</div>
					<div className="flex items-center justify-between rounded px-1.5 py-0.5 text-[7px] text-white/45">
						<div className="flex items-center gap-1">
							<FileText className="h-2.5 w-2.5 opacity-80" />
							Reports
						</div>
						<ChevronDown className="h-2 w-2 opacity-40" />
					</div>
					<div className="flex items-center justify-between rounded px-1.5 py-0.5 text-[7px] text-white/45">
						<div className="flex items-center gap-1">
							<CalendarDays className="h-2.5 w-2.5 opacity-80" />
							Calendar
						</div>
						<ChevronDown className="h-2 w-2 opacity-40" />
					</div>
					<div className="flex items-center gap-1 rounded px-1.5 py-0.5 text-[7px] text-white/45">
						<UserCheck className="h-2.5 w-2.5 opacity-80" />
						Attendance
					</div>
					<div className="mt-1 border-t border-white/10 pt-1">
						<div className="flex items-center gap-1 rounded px-1.5 py-0.5 text-[7px] text-red-400">
							<LogOut className="h-2.5 w-2.5 opacity-80" />
							Logout
						</div>
					</div>
				</div>
				<div className="flex-1 bg-[#f9fafb] p-2">
					<div className="relative mb-2 overflow-hidden rounded-md border border-gray-200 bg-white p-2">
						...
						<div className="relative z-10">
							<div className="mb-0.5 inline-flex items-center gap-0.5 rounded-full border border-[#465fff]/20 bg-[#465fff]/10 px-1.5 py-[1px] text-[6px] font-medium text-[#465fff]">
								<ShieldCheck className="h-[6px] w-[6px]" /> Admin
							</div>
							<div className="text-[9px] font-semibold text-[#111827]">
								Good morning, Admin ✨
							</div>
					...
					<div className="mb-1.5 flex gap-0.5 rounded border border-gray-200 bg-gray-50 p-[2px]">
						{['Insights', 'Performance', 'Enrollment'].map((tab, i) => (
							<div
								key={tab}
								className={`flex-1 rounded px-1 py-[1px] text-center text-[6px] font-medium ${i === 0 ? 'bg-[#465fff] text-white' : 'text-gray-400'}`}
							>
								{tab}
							</div>
						))}
		...
		<>
			...
			<div className="brochure-body pt-16 print:pt-0 bg-gray-100 min-h-screen">
				<div className="mx-auto max-w-[297mm] space-y-8 py-16 px-4 print:space-y-0 print:py-0 print:px-0">
					{/* ═══════════════════════════════════════════════ PAGE 1: Cover (light theme, aligned 2-col) ═══════════════════════════════════════════════ */}
					<div
						className="brochure-page overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg print:rounded-none print:shadow-none print:border-none"
						style={{ aspectRatio: '297/210' }}
					>
						<div className="flex h-full flex-row gap-16 p-8">
							{/* Right Column: Hero visual — light-theme feature highlights */}
							<div className="flex flex-1 flex-col justify-center">
								<div className="mb-4 border-b border-gray-100 pb-3">
									<p className="text-[11px] font-bold uppercase tracking-widest text-[#465fff]">
								...
								<p className="mb-5 text-xs leading-relaxed text-gray-500">
									From first enrollment to final report cards — SchoolMesh
									connects every role in your school so nothing falls through
									the cracks.
								</p>
									...
									{[
										{
											...
											text: 'Access from any device, anywhere. Always up to date with automatic updates — no hardware to maintain.',
											color: '#465fff',
										},
										{
											icon: CloudOff,
											title: 'Works Offline Too',
											text: 'Teachers and admins keep working without internet. Everything syncs automatically when back online.',
											color: '#f79009',
										},
										{
											icon: ShieldCheck,
											title: 'Enterprise Security',
											text: 'Secure data isolation, role-based access controls, and industry-standard encryption protect your school data.',
											color: '#12b76a',
										},
										{
											icon: Database,
											title: 'Multi-School Ready',
											text: 'Each school gets its own branded environment — independent data, users, and settings on one platform.',
											color: '#8b5cf6',
										},
									].map((item) => (
										<div
							...
							{/* Left Column: Brand + tagline + stats */}
							<div className="flex flex-1 flex-col justify-center">
								...
								<div className="mb-6 flex items-center gap-3">
									...
									<div>
										...
										<p className="text-sm font-medium text-[#465fff]">
											One platform. Every school.
										</p>
									</div>
								</div>

								<p className="mb-7 text-sm leading-relaxed text-gray-500 max-w-sm">
								...
								<div className="mb-7 inline-flex items-center gap-2 self-start rounded-full border border-[#12b76a]/30 bg-[#12b76a]/8 px-4 py-2">
								...
								<p className="mt-6 text-xs text-gray-400">www.schoolmesh.net</p>
							</div>
						</div>
					</div>

					{/* ═══════════════════════════════════════════════ PAGE 2: About + Comparison ═══════════════════════════════════════════════ */}
					<div
						className="brochure-page overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg print:rounded-none print:shadow-none print:border-none"
						style={{ aspectRatio: '297/210' }}
					>
						<div className="flex h-full flex-row gap-16 p-8">
							...
							<div className="flex flex-1 flex-col">
								<div className="mb-4 flex items-center justify-between border-b border-gray-100 pb-3">
									...
									<span className="text-[11px] text-gray-400">02 / 04</span>
								</div>

								<p className="mb-1 text-[11px] font-bold uppercase tracking-widest text-[#465fff]">
									About SchoolMesh
								</p>
								...
								<p className="mb-5 text-xs leading-relaxed text-gray-500">
									...
									students in one intelligent system. Built with modern
									technology and designed for how schools actually operate.
								</p>
									...
									{[
										{
											icon: Globe,
											title: 'Cloud-Native',
											text: 'Access from any device, anywhere. No hardware to maintain. Always up to date with automatic updates.',
											color: '#465fff',
										},
										{
											icon: Database,
											title: 'Multi-Tenant Architecture',
											text: 'Each school gets its own branded environment with independent data, users, and settings — all on one shared platform.',
											color: '#12b76a',
										},
										{
											icon: CloudOff,
											title: 'Offline-First Design',
											text: 'Keep working without internet. Teachers and admins can continue offline — everything syncs automatically when back online.',
											color: '#f79009',
										},
										{
											icon: ShieldCheck,
											title: 'Enterprise Security',
											text: 'Industry-standard encryption, secure data isolation, role-based access controls, and regular security audits.',
											color: '#8b5cf6',
										},
									].map((item) => (
										<div
							...
							<div className="flex flex-1 flex-col">
								<div className="mb-4 flex items-center justify-between border-b border-gray-100 pb-3">
									...
									<span className="text-[11px] text-gray-400">Comparison</span>
								</div>
									...
									<table className="w-full">
										<thead>
											<tr className="bg-gray-50">
												...
												<th className="px-3 py-2 text-center text-[10px] font-bold uppercase tracking-wider text-[#465fff]">
													SchoolMesh
												</th>
										...
										<tbody>
											{comparisonRows.map((row, i) => (
												...
												>
													<td className="px-3 py-1.5 text-[11px] font-medium text-[#111827]">
														{row.feature}
													</td>
													<td className="px-3 py-1.5 text-center">
														{row.schoolMesh === true ? (
															<CheckCircle2 className="mx-auto h-4 w-4 text-[#12b76a]" />
														) : (
													...
													<td className="px-3 py-1.5 text-center">
														{row.traditional === true ? (
															<CheckCircle2 className="mx-auto h-4 w-4 text-gray-400" />
					...
					{/* ═══════════════════════════════════════════════ PAGE 3: Pricing (was Features) + Contact (was Why SchoolMesh) ═══════════════════════════════════════════════ */}
					<div
						className="brochure-page overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg print:rounded-none print:shadow-none print:border-none"
						style={{ aspectRatio: '297/210' }}
					>
						<div className="flex h-full flex-row gap-16 p-8">
							{/* Left Column: Pricing (moved from page 4) */}
							<div className="flex flex-1 flex-col">
								<div className="mb-4 flex items-center justify-between border-b border-gray-100 pb-3">
									<div className="flex items-center gap-2">
										<Image
									...
									<span className="text-[11px] text-gray-400">03 / 04</span>
								</div>

								<p className="mb-1 text-[11px] font-bold uppercase tracking-widest text-[#465fff]">
									Pricing
								</p>
								<h2 className="mb-2 text-xl font-bold tracking-tight text-[#111827]">
									Simple, transparent, and affordable pricing.
								</h2>
								<p className="mb-4 text-[11px] leading-relaxed text-gray-500">
									Two simple plans with per-student annual pricing, plus a
									custom option for schools and networks that prefer a fixed
									annual fee.
								</p>
										...
										>
											...
											<div className="flex flex-wrap gap-1.5">
												{plan.features.map((f) => (
													<span
														key={f}
														className="inline-flex items-center gap-1 rounded-full bg-gray-50 px-2 py-0.5 text-[9px] text-gray-600"
													>
								...
								<div className="rounded-xl border-2 border-dashed border-[#465fff]/30 bg-[#465fff]/[0.03] p-4">
									...
									<div className="flex flex-wrap gap-1.5">
										{customPlan.features.map((f) => (
											<span
												key={f}
												className="inline-flex items-center gap-1 rounded-full bg-white px-2 py-0.5 text-[9px] text-gray-600 border border-gray-100"
											>
												<CheckCircle2 className="h-3 w-3 text-[#465fff]" />
												{f}
											</span>
										))}
									</div>
								...
								<p className="mt-auto pt-3 text-center text-[9px] text-gray-300">
									Start free · No credit card required
								</p>
							</div>

							{/* Right Column: Contact (moved from page 4) */}
							<div className="flex flex-1 flex-col">
								<div className="mb-4 border-b border-gray-100 pb-3">
									<p className="text-[11px] font-bold uppercase tracking-widest text-[#465fff]">
										Contact
									</p>
									<h2 className="mt-1 text-lg font-bold tracking-tight text-[#111827]">
									...
									{[
										{
											icon: Mail,
											label: 'Email',
											value: 'info@schoolmesh.net / amossenkao@gmail.com',
											color: '#465fff',
										},
										{
											icon: Phone,
											label: 'Phone',
											value: '+231 776949463 / +231 887956586',
											color: '#12b76a',
										},
										{
											icon: Globe,
								...
								<div className="mb-4 space-y-2">
									{testimonials.map((t) => (
										...
										>
											...
											<p className="text-[9px] italic leading-relaxed text-gray-600">
												&quot;{t.quote}&quot;
											</p>
											<p className="mt-1 text-[9px] font-bold text-[#111827]">
												{t.name}{' '}
								...
								<div className="mt-auto flex items-center gap-4 rounded-xl bg-[#111827] p-4">
									...
									<div>
										...
										<p className="mt-1 text-[9px] font-medium text-[#465fff]">
											www.schoolmesh.net
										</p>
									</div>
								</div>

								<p className="mt-2 text-center text-[9px] text-gray-300">
					...
					{/* ═══════════════════════════════════════════════ PAGE 4: Features (was page 3) + Why SchoolMesh (was page 3 right) ═══════════════════════════════════════════════ */}
					<div
						className="brochure-page overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg print:rounded-none print:shadow-none print:border-none"
						style={{ aspectRatio: '297/210' }}
					>
						<div className="flex h-full flex-row gap-16 p-8">
							{/* Left Column: Features (moved from page 3) */}
							<div className="flex flex-1 flex-col">
								<div className="mb-4 flex items-center justify-between border-b border-gray-100 pb-3">
									<div className="flex items-center gap-2">
										<Image
									...
									<span className="text-[11px] text-gray-400">04 / 04</span>
								</div>
								...
								<div className="mb-3 grid grid-cols-2 gap-2">
									{features.map((f) => (
										<div
											key={f.title}
											className="flex items-start gap-1.5 rounded-lg border border-gray-100 p-2"
										>
											<div
											...
											<div>
												<h3 className="text-[10px] font-bold text-[#111827]">
													{f.title}
												</h3>
												<p className="mt-0.5 text-[8px] leading-relaxed text-gray-500">
													{f.description}
												</p>
											</div>
										</div>
								...
								<h3 className="mb-1 text-sm font-bold tracking-tight text-[#111827]">
									Everything you need, one glance away.
								</h3>
								<p className="mb-2 text-[9px] leading-relaxed text-gray-500">
									A role-aware dashboard that greets every user by name, shows
									live insights, and adapts to your role.
								</p>
							...
							{/* Right Column: Why Schools Choose Us (moved from page 3) */}
							<div className="flex flex-1 flex-col">
								<div className="mb-4 border-b border-gray-100 pb-3">
									<span className="text-xs font-bold text-[#111827]">
								...
								<p className="mb-4 text-[11px] leading-relaxed text-gray-500">
									Beyond the core modules, SchoolMesh delivers standout
									capabilities that set it apart from any other platform.
								</p>
								...
								<div className="mb-4 space-y-3">
									...
									<div className="rounded-xl border border-[#465fff]/20 bg-[#465fff]/[0.03] p-3.5">
										...
										<p className="text-[10px] leading-relaxed text-gray-500">
											...
											— instantly, from any device, anywhere in the world.
											One-click share via link or direct transfer. No printing
											required.
										</p>
									</div>
									...
									<div className="rounded-xl border border-[#12b76a]/20 bg-[#12b76a]/[0.03] p-3.5">
										...
										<p className="text-[10px] leading-relaxed text-gray-500">
											Every generated report includes a unique QR code anyone
											can scan to verify its authenticity — protecting against
											forgery and giving institutions complete confidence.
										</p>
									</div>
									...
									<div className="rounded-xl border border-[#f79009]/20 bg-[#f79009]/[0.03] p-3.5">
										...
										<p className="text-[10px] leading-relaxed text-gray-500">
											Our dedicated support team is available to help with
											onboarding, training, migration, and any issues. Premium
											plan customers receive priority support with faster
											response times.
										</p>
									</div>
									...
									<div className="rounded-xl border border-[#8b5cf6]/20 bg-[#8b5cf6]/[0.03] p-3.5">
										...
										<p className="text-[10px] leading-relaxed text-gray-500">
											...
											notifications. Same data across all devices — always in
											sync.
										</p>
									</div>
								</div>
